...
function _resolver_resource_all_offset($resource, $p_index_first, $p_index_last){
	...
	if($system->_get_http_response_code($adress_resolver.'resource/'.$resource.'/o/'.$p_index_first.'/'.$p_index_last) != "404"){
    	$context = stream_context_create(array('http' => array('header'=>'Connection: close\r\n')));
    	$result1 = file_get_contents($adress_resolver.'resource/'.$resource.'/o/'.$p_index_first.'/'.$p_index_last,false,$context);
